...
import { replacementEntries, publishLibraryImages, websiteImageAllowlist } from "./publish-library-images.mjs";
...
async function fixture(t) {
  ...
  return { projectRoot, png, allowlist: new Set([SOURCE, SECOND]) };
}
