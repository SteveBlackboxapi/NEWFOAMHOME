  ...
  return (
    <section className="min-h-[80vh] flex items-center justify-center px-6 bg-surface">
      <div className="text-center max-w-[480px]">
        ...
        <h1 className={`${FG_SB} text-[36px] leading-tight tracking-[-0.8px] text-text mb-4`}>
          Nothing here
        </h1>
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <Link to="/features" className={`${FG_M} bg-raised border border-border text-text text-[15px] px-7 h-11 rounded-full flex items-center hover:bg-border transition-colors`}>
            See features
          </Link>
        </div>
      </div>
